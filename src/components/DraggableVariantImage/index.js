...
const DraggableVariantImage = ({ src, variantFieldName, moveItem, findItem, onDelete }) => {
  ...
  const [{ isDragging }, drag] = useDrag({
    item: { type: dndTypes.VARIANT_IMAGE, src, variantFieldName, originalIndex },
    collect: (monitor) => ({
...
export default DraggableVariantImage;
